          ...
          <tbody>
            <tr>
              ...
              <td style="text-align: right; padding: 10px; border-top: 1px solid #ccc;border-right: 1px solid #ccc;">
                <h2 style="font-size: 16pt; font-weight: 600; margin: 0px;    white-space: nowrap;text-transform: uppercase;">${appName}</h2><br />
                ...
                <table cellpadding="0px" style="vertical-align: top;" cellspacing="0" width="100%">
                    ...
                    <td style="border-left: 1px solid #ccc; border-right: 1px solid #ccc; padding: 10px; text-align: center;">
                      <h3 style=" margin: 0px;padding-bottom: 15px; font-size: 10.5pt; font-weight:bold;">Hello
                        ...
                        <p style=" margin: 0px;    margin-top: 10px; color: #02008e; font-size: 9.5pt;">Please verify your
                          email to finish the login process for your ${appName} account. You'll need to use the
                  ...
                  <tr>
                    <td style="padding: 10px; border: 1px solid #ccc; text-align: center; background-color: #f9fff6;">
                      <p style=" margin: 0px;font-size: 8.5pt;">If you did not associate your email address with a ${appName}
                      ...
                      <h6 style="font-size: 10.5pt;margin: 0px; font-weight: bold;text-transform: uppercase;">${appName}</h6>
