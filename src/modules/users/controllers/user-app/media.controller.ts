...
import driverMediaModel from "@/modules/drivers/models/driverMedia.model";
...
//         const keykey = `websites/65f352b0d0b96c21405031be/drivers/${request?.user?._id}/${file.name}`;
...
//             if (err) {
//                 return error(400, { success: false, data: '', message: err });
//             } else if (data) {
//                 await driverMediaModel.create({
//                     name: file.name,
//                     fileName: file.name,
